...
#ifndef NFCREADER_SWIFT_H
#define NFCREADER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NFCReader",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9NFCReader8Localize")
...
SWIFT_CLASS("_TtC9NFCReader14PassportReader") SWIFT_AVAILABILITY(ios,introduced=13)
...
SWIFT_CLASS("_TtC9NFCReader15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(NFCReader)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(NFCReader)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(NFCReader)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(NFCReader)) <NSURLSessionTaskDelegate>
...
@interface UIButton (SWIFT_EXTENSION(NFCReader))
@property (nonatomic, copy) IBInspectable NSString * _Nullable localizeKey;
@end


@interface UILabel (SWIFT_EXTENSION(NFCReader))
@property (nonatomic, copy) IBInspectable NSString * _Nullable localizeKey;
@end


@interface UINavigationItem (SWIFT_EXTENSION(NFCReader))
@property (nonatomic, copy) IBInspectable NSString * _Nullable localizeKey;
@end


@interface UITextField (SWIFT_EXTENSION(NFCReader))
@property (nonatomic, copy) IBInspectable NSString * _Nullable localizeKey;
@end


@interface UITextView (SWIFT_EXTENSION(NFCReader))
@property (nonatomic, copy) IBInspectable NSString * _Nullable localizeKey;
@end
